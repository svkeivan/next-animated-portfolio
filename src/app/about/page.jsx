      ...
      >
        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2'>
          ...
          <div className='flex flex-col gap-12 justify-center'>
            ...
            {/* BIOGRAPHY DESC */}
            <p className='text-lg'>
              As a front end developer with 5 years of experience, I specialize
              in building clean, responsive user interfaces for web and mobile
              apps. I have expert skills in HTML, CSS, JavaScript, and popular
              frameworks like React and Next.js. I pride myself on writing
              well-structured, optimized code that provides users with a smooth,
              engaging experience. My strengths include quickly translating
              designer mockups into functional interfaces, implementing
              responsive design, and writing technical documentation. I stay
              up-to-date by regularly learning new techniques and attending
              conferences. I&apos;m passionate about using technology to solve
              problems and enjoy collaborating with team members to bring
              projects from concept to launch.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className='italic'>
              Do what you can, with what you have, where you are.{" "}
              <span className='text-xs'>Theodore Roosevelt</span>
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
